...
export default function ToursSection() {
  ...
  return (
    <section id="tours" className="relative w-full min-h-[90vh] bg-background text-foreground overflow-hidden">
      {/* Desktop Layout */}
      <div className="hidden lg:block w-full h-[90vh]">
      ...
      <div className="lg:hidden w-full flex flex-col">
        ...
        <div className="bg-[#FAFAFA] py-4 w-full">
            <Carousel
                  setApi={setApi}
                  opts={{
                  align: 'start',
              ...
              >
                  <CarouselContent className="-ml-4">
                  {tours.map((tour, index) => (
                      <CarouselItem key={tour.id} className="pl-4 basis-2/3">
                      <button
                          onClick={() => handleTourNameClick(index)}
                          className="w-full text-left focus:outline-none"
                      >
