// src/app/(site)/gallery/gallery-page-client.tsx
'use client';
...
type GalleryPageClientProps = {
    items: GalleryItem[];
    heroContent: GalleryPageHeroContent | null;
}
...
export default function GalleryPageClient({ items, heroContent }: GalleryPageClientProps) {
